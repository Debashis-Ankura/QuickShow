...
const HeroSection = () => {
  ...
  return (
    <div className='flex flex-col items-start justify-center gap-4 px-6 md:px-16 lg:px-36 bg-[url("/backgroundImage.png")] bg-cover bg-center h-screen'>
      <img src={assets.marvelLogo} alt="marvel ra khete geche" className='max-h-11 lg:h-11 mt-20' />
      ...
      <div className='flex items-center gap-4 text-gray-300'>
        ...
        <div className='flex items-center gap-1'>
            <ClockIcon className='w-4.5 h-4.5'/>2h 47m
        </div>
      </div>
      <p className='max-w-md text-gray-300'>In a post-apocalypt world where cities ride on wheels and consume each other to survive, two people meet in London and try to stop a conspiracy.</p>
